...
//					pa.trackEvent("Donate-Error", "Problem setting up Billing", result.toString(), 1);
				...
				else
				{
					...
					progress = ProgressDialog.show(SettingActivity.this, getString(R.string.donate_progress_dialog_title),
		...
		this.mButton.setOnClickListener(new  View.OnClickListener(){
			...
			public void onClick(View v) {
				//start purchase flow
				mHelper.launchPurchaseFlow(SettingActivity.this, SKUS[selectedItem], REQ_CODE+selectedItem, purchaseListener, "");
...
//				pa.trackEvent("Donate-Error", "Could not query inventor", result.getMessage(), 1);
			...
			if(mSpinner != null)
			{
				...
				mAdapter = new ArrayAdapter<String>(SettingActivity.this, R.layout.donate_item, donateItems);
